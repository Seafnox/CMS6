...
$this->redirect(array('update', 'id' => $model-><?php echo $this->tableSchema->primaryKey; ?>, 'returnUrl' => $_POST["returnUrl"]));
...
$criteria->compare('<?php echo $this->tableSchema->primaryKey; ?>', $_POST["items"]);
