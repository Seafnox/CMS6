 ...
 */
class GeoStreets extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('rajon_id, title, socr, index', 'required'),
			array('rajon_id, index', 'numerical', 'integerOnly'=>true),
			array('title', 'length', 'max'=>255),
			array('socr', 'length', 'max'=>32),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, rajon_id, title, socr, index', 'safe', 'on'=>'search'),
		);
	}
