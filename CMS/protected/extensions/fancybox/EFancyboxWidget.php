 ...
 */
class EFancyboxWidget extends CWidget // @TODO обновить fancybox до версии 2
{
	/**
	 ...
	 */
	public $selector='a[href$=\'.jpg\'],a[href$=\'.png\'],a[href$=\'.gif\'],a[href$=\'.JPG\'],a[href$=\'.PNG\'],a[href$=\'.GIF\']'; //a:has(img)
	/**
	...
	protected function registerClientScript()
	{
		...
		$cs->registerScript($this->getId(),' $("body").on("content-updated", function(){ $("'.$this->selector.'").fancybox('.CJavaScript::encode($this->options).'); }); $("'.$this->selector.'").fancybox('.CJavaScript::encode($this->options).');',CClientScript::POS_READY);
	}
}
